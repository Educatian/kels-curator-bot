...
const message = [
  ...
  '',
  '`/profile`도 더 커뮤니티 연결형으로 바뀌었습니다. 관심 주제를 add/list하면 해당 관심사와 맞는 최근 KELS 원문 3개, 채널, 날짜, 관련도, 연결 질문을 개인 응답으로 붙입니다. 새 회원 온보딩 thread에도 자기소개 관심사와 연결되는 archive 원문을 함께 제안합니다.',
  '',
